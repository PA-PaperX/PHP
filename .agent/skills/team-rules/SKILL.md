...
- **Frontend:** Nuxt 3, Vue 3 (Composition API `<script setup lang="ts">`), TypeScript.
- **Styling & UI:** Tailwind CSS and Nuxt UI (Use native components like `UButton`, `UIcon`, `UInput`, etc., and `i-heroicons-*` for icons).
- **Backend:** Native PHP APIs.
- **CRITICAL:** DO NOT introduce React, Next.js, Bootstrap, Shadcn-Vue, or any other frameworks. Stick strictly to the existing stack.

## 2. 🛑 DO NOT MODIFY STABLE SYSTEMS OR THEMES
...
## 3. ⚠️ CONFLICT AVOIDANCE & DATABASE INTEGRITY
...
## 5. 🛡️ BACKUP IMPORTANT FILES BEFORE EDITING
