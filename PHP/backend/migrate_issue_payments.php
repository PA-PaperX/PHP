...
try {
    ...
    if (!columnExists($db, 'issues', 'slip_image_path')) {
        $db->exec("ALTER TABLE issues ADD COLUMN slip_image_path VARCHAR(255) DEFAULT NULL AFTER paid_at");
        echo "Added issues.slip_image_path\n";
    } else {
        echo "issues.slip_image_path already exists\n";
    }
