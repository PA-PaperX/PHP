...
const fetchTickets = async () => {
  try {
    const data = await $fetch<any>(`${baseUrl}/api/tickets/admin_list`, {
      credentials: 'include'
    })
...
const fetchMessages = async () => {
  ...
  try {
    const data = await $fetch<any>(`${baseUrl}/api/tickets/messages?ticket_id=${selectedTicket.value.id}&last_id=${lastMessageId}`, {
      credentials: 'include'
    })
...
const sendMessage = async () => {
  ...
  try {
    await $fetch(`${baseUrl}/api/tickets/messages?ticket_id=${selectedTicket.value.id}`, {
      method: 'POST',
      body: { message: text },
      credentials: 'include'
    })
...
const grantReset = async () => {
  ...
  try {
    await $fetch(`${baseUrl}/api/tickets/grant_reset`, {
      method: 'POST',
...
const submitReject = async () => {
  ...
  try {
    await $fetch(`${baseUrl}/api/tickets/reject_ticket`, {
      method: 'POST',
