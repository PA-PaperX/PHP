...
$webhookTitle = "🎫 คำขอรีเซ็ตรหัสผ่านใหม่ (Ticket #{$ticketId})";
$desc = "มีผู้ใช้ลืมรหัสผ่านและต้องการรีเซ็ตใหม่\n📧 **อีเมล:** {$email}";
sendDiscordWebhook($webhookTitle, $desc, [], "#8B5CF6", null, 'ticket'); // Purple color
